...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/10 09:35:24 by antoda-s          #+#    #+#             */
/*   Updated: 2024/05/10 09:35:51 by antoda-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/// @brief When 'this' is hitted by an attacker, its ClapTrap::_Health is decreased
///			the amount indicated by 'amount'
...
{
	out << "\nClapTrap Name (" << objToPrint.getName() << "): " << std::endl;
