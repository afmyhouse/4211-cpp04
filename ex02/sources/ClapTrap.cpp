...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/10 11:58:09 by antoda-s          #+#    #+#             */
/*   Updated: 2024/05/10 14:18:45 by antoda-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string& target) {
	if (!this->isActive()) {
		std::cout << "ClapTrap " << this->getName() << " is out of Energy/Health and can't attack " << target << std::endl;
		return ;
	}
...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << "ClapTrap " << this->_Name	<< " hitted and lost ";
...
void ClapTrap::beRepaired(unsigned int amount) {
	...
	this->_Health += amount;
	this->_Energy--;
	std::cout << "ClapTrap " << this->getName() << " has been repaired " << amount << " Health Points" << std::endl;
	std::cout << *this << std::endl;
}
